function [iou,h,min_z,max_z] = iouSDFS(X,X_Ref,pts_ref,nphi,nth)
    % get shape points for estimate
    [pts,min_z,max_z] = getShapePoints2dTop(X,nphi,nth);
    h = max_z - min_z;
...
function [pts,min_z,max_z] = getShapePoints2dTop(X,nphi,nth)
